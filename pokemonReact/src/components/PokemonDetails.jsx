...
export default function PokemonDetails() {
  ...
  /**
   * REFACTORED: Removed getTypeColor function
   * Now using centralized getTypeColor from constants/pokemonTypes.js
   * This eliminates code duplication and ensures color consistency
   */
